...
| S5-02/03/04 | PARTIAL / PUBLISHED_NOT_ACCEPTED | Exact-candidate assets are durably published and hash-verified; complete per-file capture metadata, accepted independent review, trusted validation and owner disposition remain pending |
...
### S5 durable evidence publication — 2026-09-14

- Repository/environment: `alirezasafaeigfx/alirezasafaeisystems`, `GITHUB_MAIN` at `ba4528ed55d6c983378953c556e821bb2e7d95b6`; evidence candidate `08d64742282cb7456ffbbc6077baa29d505a0741`; source Actions artifact `9890025924`, run `33746574202`.
- Outcome: published the evidence-only prerelease [`evidence-s5-08d64742282cb7456ffbbc6077baa29d505a0741`](https://github.com/alirezasafaeigfx/alirezasafaeisystems/releases/tag/evidence-s5-08d64742282cb7456ffbbc6077baa29d505a0741). The tag resolves to the candidate. The source ZIP matched the recorded SHA-256 `36e9a11c0ca1f4a91575b6aef2aa47663307d2bd4bae1aa5dbfe16d5416d672f`.
- Classification: retained 31 visually inventoried public-route PNG captures, two deterministic JSON indexes, one sanitized lab-performance summary, and one package manifest. Excluded the draft acceptance manifest, raw diagnostics containing loopback/internal data, CI-only metadata, duplicate opaque recordings, and videos without accepted visual inspection.
- Retrieval evidence: `35/35` assets returned HTTP 200 without authentication; `35/35` byte lengths and SHA-256 values matched, totaling `23,870,406` bytes. Package manifest digest: `sha256:e7c0fc576221671b31280dd984dbd33e3fdb86b59c5ab43b668252a8181a5903`.
- State/next dependency: public retrieval is complete, while the publication contract remains `PARTIAL / PUBLISHED_NOT_ACCEPTED` because the package manifest lacks review identity and per-file capture conditions for every retained screenshot. A separately versioned, fully reviewed manifest is required; trusted S5 validator acceptance, exact-scope provider `APPROVED` review, candidate-identity validation and owner visual disposition remain blockers. No staging, deployment, Production release, or field-metric claim was made.
