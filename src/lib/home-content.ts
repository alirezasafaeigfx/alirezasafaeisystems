...
const content: Record<Language, HomeContent> = {
  fa: {
    ...
    proof: {
      ...
      items: [
        { id: 'persiantoolbox-case-study', label: 'PersianToolbox', value: 'مطالعه موردی قابل بررسی', source: 'صفحه عمومی مطالعه موردی PersianToolbox', sourceUrl: '/case-studies/asdev-persiantoolbox-platform', period: 'بررسی مسیر عمومی در ۲۰۲۶-۰۸-۳۰', method: 'بررسی مسیر و توضیحات منتشرشده', verificationDate: '2026-08-30', reviewedBy: 'بازبینی مستقل محتوای عمومی', reviewedAt: '2026-08-30', reviewState: 'accepted' },
        { id: 'infrastructure-rescue-case-study', label: 'Infrastructure Localization Rescue', value: 'مسیر انتشار قابل بررسی', source: 'صفحه عمومی مطالعه موردی نجات زیرساخت', sourceUrl: '/case-studies/infrastructure-localization-rescue', period: 'بررسی مسیر عمومی در ۲۰۲۶-۰۸-۳۰', method: 'بررسی روایت مطالعه موردی و شواهد انتشار', verificationDate: '2026-08-30', reviewedBy: 'بازبینی مستقل محتوای عمومی', reviewedAt: '2026-08-30', reviewState: 'accepted' },
        { id: 'audit-systems-product', label: 'Audit Systems', value: 'گردش‌کار ارزیابی قابل بررسی', source: 'صفحه عمومی محصول Audit Systems', sourceUrl: 'https://audit.alirezasafaeisystems.ir/', period: 'بررسی مسیر عمومی در ۲۰۲۶-۰۸-۳۰', method: 'بررسی سطح عمومی محصول و مسیر ارزیابی', verificationDate: '2026-08-30', reviewedBy: 'بازبینی مستقل محتوای عمومی', reviewedAt: '2026-08-30', reviewState: 'accepted' },
      ],
    },
    principles: [
