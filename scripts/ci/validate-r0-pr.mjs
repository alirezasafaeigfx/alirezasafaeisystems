...
const ALLOWED_PUBLIC_EXPERIENCE_PATHS = [
  ...
  /^scripts\/ci\/(validate-(r0-pr|public-experience-evidence(?:-trusted)?)|measure-public-experience-budget|public-experience-attribution|run-public-experience-comparison|verify-home-initial-chunks|create-public-experience-evidence-draft|inspect-public-experience-build|run-lighthouse-budget)\.mjs$/,
  /^scripts\/test\/seed-playwright-discover\.mjs$/,
  /^tests\/ci\/(home-initial-chunks|inspect-public-experience-build|playwright-discover-fixture|public-experience-long-task-attribution|public-experience-performance-contract|public-experience-remote-artifact|public-experience-review-copy-contract|public-experience-review-provenance|public-experience-review-scope-cli|lighthouse-budget-runner|validate-(r0-pr|public-experience-evidence))\.test\.ts$/,
...
const PATH_CATEGORIES = [
  ...
  ['ci', /^scripts\/deploy\/live-verify(?:-classification)?\.mjs$/],
