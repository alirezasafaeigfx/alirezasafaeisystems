...
const ALLOWED_PUBLIC_EXPERIENCE_PATHS = [
  ...
  /^scripts\/ci\/(validate-(r0-pr|public-experience-evidence)|measure-public-experience-budget|run-public-experience-comparison|verify-home-initial-chunks|create-public-experience-evidence-draft)\.mjs$/,
  /^scripts\/test\/seed-playwright-discover\.mjs$/,
  /^tests\/ci\/(home-initial-chunks|playwright-discover-fixture|public-experience-performance-contract|validate-(r0-pr|public-experience-evidence))\.test\.ts$/,
